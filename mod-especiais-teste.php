<div class="row">
  ...
  <div class="container no-padding">
        ...
        <h2><i class="icon-logo-agencia2017-01"></i> Especiais</h2>
         ...
         <a class="right grey-text text-darken-3-text" href="http://www.agencia.ac.gov.br/categoria/especiais/">Ver todos <i class="fa fa-long-arrow-right" style="font-size: 12px;" aria-hidden="true"></i>
     </a>
         </div>
