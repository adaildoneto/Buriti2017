  ...
  <div class="container"  style="padding: 0 10px; margin-top: 20px;">
     ...
     <div id="RedeAldeia" class="col s12  redealdeia no-padding">
         <div class="btn-aldeia">
					<div class="col s12 m3 l3"><a href="https://docs.google.com/forms/d/e/1FAIpQLSfDV-19Q37lftqIzZrx6j2lBHT-v0S_2aHC8AzQ2rV8kI-YcA/viewform?vc=0&c=0&w=1" class="waves-effect waves-teal btn-flat lighten-1 white-text" style="">
