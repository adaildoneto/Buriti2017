...
?>
<?php get_header(); ?>
<div class="row header img-slider" style="width:100%; height: 720px; background: url('<?php the_post_thumbnail_url( '' ); ?>'):  background-repeat: no-repeat; background-attachment: fixed; background-position: bottom;">
...
<!-- <div class="row">
 ...
 <!-- Modal Structure -->
   ...
   <div class="col s12 m10 l10 offset-m1 offset-l1">
            <img src="http://www.agencia.ac.gov.br/wp-content/uploads/2017/11/amazonbon.png" alt="" class="responsive-img">
      </div>
    </div>
  </div>
...
<div class="col s12 no-padding">
         ...
         <h5><i class="icon-logo-agencia2017-01"></i> Meio Ambiente no Acre</h5>
          </div>
          <div class="col s6" style="padding-top: 30px;">
...
<!-- Noticias 1 // Inicio do Loop -->
<?php query_posts('showposts=3&cat=15&offset=0');?>
<?php if (have_posts()): while (have_posts()) : the_post();?>
