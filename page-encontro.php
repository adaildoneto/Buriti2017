<?php
/*
Template Name: Página do Encontro de Governa
*/
?>
<?php get_header(); ?>
...
<div class="container">
  <div class="row">
   <div class="slider-noticias-container">
    ...
    <?php query_posts('showposts=1&tag=encontroseguranca');?>
...
<div class="clearfix"></div>
    ...
    <div class="col s12 m12 l6">
    <?php query_posts('showposts=1&tag=encontroseguranca&offset=1');?>
    <?php if (have_posts()): while (have_posts()) : the_post();?>
	<a href="<?php the_Permalink()?>" title="<?php the_title();?>" >
	<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'slider-noticias2' ); ?>
      <div class="slider-noticias img-slider" style="background: url('<?php echo $image[0]; ?>');">
...
<div class="clearfix"></div>
    ...
    <div class="col s12 m12 l6">
    <?php query_posts('showposts=1&tag=encontroseguranca&offset=2');?>
    <?php if (have_posts()): while (have_posts()) : the_post();?>
	<a href="<?php the_Permalink()?>" title="<?php the_title();?>" >
	<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'slider-noticias2' ); ?>
      <div class="slider-noticias img-slider" style="background: url('<?php echo $image[0]; ?>');">
...
<div class="clearfix"></div>
    ...
    <div class="col s12 m12 l6">
    <?php query_posts('showposts=1&tag=encontroseguranca&offset=3');?>
    <?php if (have_posts()): while (have_posts()) : the_post();?>
	<a href="<?php the_Permalink()?>" title="<?php the_title();?>" >
	<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'slider-noticias2' ); ?>
      <div class="slider-noticias img-slider" style="background: url('<?php echo $image[0]; ?>');">
...
<div class="col s12 no-padding">
         ...
         <h5><i class="icon-logo-agencia2017-01"></i> Sobre o encontro</h5>
          ...
          <a class="right grey-text text-darken-3" href="http://www.agencia.ac.gov.br/tag/encontroseguranca/">Ver todos <i class="fa fa-long-arrow-right" style="font-size: 12px;" aria-hidden="true"></i>
      </a>
          </div>
...
<?php query_posts('showposts=3&tag=encontroseguranca&offset=4');?>
<?php if (have_posts()): while (have_posts()) : the_post();?>
