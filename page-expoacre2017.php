<?php
/*
Template Name: Pagína da Expoacre 2017
*/
?>
<?php get_header(); ?>
...
<div class="row">
  ...
  <img src="http://www.agencia.ac.gov.br/wp-content/uploads/2017/07/expoa-2017.png" class="center responsive-img" height="50">
  </div>
</div>
  <div class="row">
   <div class="slider-noticias-container">
    <div class="col s12 m12 l6">
    <?php query_posts('showposts=1&tag=expoacre-2017');?>
...
<div class="clearfix"></div>
    ...
    <div class="col s12 m12 l6">
    <?php query_posts('showposts=1&tag=expoacre-2017&offset=1');?>
    <?php if (have_posts()): while (have_posts()) : the_post();?>
	<a href="<?php the_Permalink()?>" title="<?php the_title();?>" >
	<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'slider-noticias2' ); ?>
      <div class="slider-noticias img-slider" style="background: url('<?php echo $image[0]; ?>');">
...
<div class="clearfix"></div>
    ...
    <div class="col s12 m12 l6">
    <?php query_posts('showposts=1&tag=expoacre-2017&offset=2');?>
    <?php if (have_posts()): while (have_posts()) : the_post();?>
	<a href="<?php the_Permalink()?>" title="<?php the_title();?>" >
	<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'slider-noticias2' ); ?>
      <div class="slider-noticias img-slider" style="background: url('<?php echo $image[0]; ?>');">
...
<div class="clearfix"></div>
    ...
    <div class="col s12 m12 l6">
    <?php query_posts('showposts=1&tag=expoacre-2017&offset=3');?>
    <?php if (have_posts()): while (have_posts()) : the_post();?>
	<a href="<?php the_Permalink()?>" title="<?php the_title();?>" >
	<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'slider-noticias2' ); ?>
      <div class="slider-noticias img-slider" style="background: url('<?php echo $image[0]; ?>');">
...
<div class="row">
    <div class="container center-align">
  <img src="http://www.agencia.ac.gov.br/wp-content/uploads/2017/07/logos-imc2017-kfw.png" class="center responsive-img">
  </div>
</div>-->
<div class="row">
<div class="col s12 m8 l8">
      <div class="card painel-noticias">
        <?php query_posts('showposts=1&tag=expoacre-2017&offset=4');?>
        <?php if (have_posts()): while (have_posts()) : the_post();?>
...
<div class="col s12 m4">
      <div class="card painel-noticias">
        <?php query_posts('showposts=1&tag=expoacre-2017&offset=6');?>
  ...
  <div class="col s12 m4">
      <div class="card painel-noticias">
        <?php query_posts('showposts=1&tag=expoacre-2017&offset=7');?>
  ...
  <div class="col s12 m4">
      <div class="card painel-noticias">
        <?php query_posts('showposts=1&tag=expoacre-2017&offset=8');?>
...
<?php query_posts('showposts=9&tag=expoacre-2017&offset=9');?>
<?php if (have_posts()): while (have_posts()) : the_post();?>
...
<!-- BoTão de mais notícias -->
    <div class="col s12">
    <a href="http://www.agencia.ac.gov.br/tag/expoacre-2017" class="btn orange btn-mais">Mais da Expoacre 2017</a>
  </div>
