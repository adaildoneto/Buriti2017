...
<div class="row testesidebar">
  <h3>Assunto: <?php single_tag_title(); ?></h3>
    ...
    <div class="card painel-noticias2">
      <a href="<?php the_Permalink()?>" title="<?php the_title();?>">
        <?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'slider-noticias' ); ?>
            <div class="bloco-img-noticias5 especiais-img" style="background: url('<?php echo $image[0]; ?>');">
      ...
      <div class="bloco-des-noticias">
            <span class="destaque-chamada">
                  <?php $key="Chamada titulo";echo get_post_meta($post->ID,$key,true)?>
            </span>
